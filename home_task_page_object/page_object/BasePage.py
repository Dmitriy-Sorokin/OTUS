...
class BasePage:
    ...
    def _verify_link_text_presence(self, link_text):
        try:
    ...
    def _verify_element_present(self, locator: tuple):
        try:
    ...
    def _element(self, locator: tuple):
        return self._verify_element_present(locator)
    ...
    def get_param_url(self, param: str):
        self.browser.get(self.browser.url + param)
